...
public class DailyActivityController {
    ...
    public DataResponse addAndUpdDailyActivity(@RequestBody DataRequest dataRequest){
        return dailyActivityService.addAndUpdDailyActivity(JsonUtil.prase(dataRequest.get("dailyActivity"), DailyActivity.class));
    }
    ...
    public DataResponse deleteByStudentId(@RequestBody DataRequest dataRequest){
        return dailyActivityService.deleteByStudentId(JsonUtil.prase(dataRequest.get("id"), Integer.class));
    }

    //查找某学生的信息
    @PostMapping("/findByStudent")
    public DataResponse findByStudentId(@RequestBody DataRequest dataRequest){
        return dailyActivityService.findByStudentId(JsonUtil.prase(dataRequest.get("id"), Integer.class));
    }
